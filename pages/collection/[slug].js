...
export default function CollectionDetail(props) {
  ...
  useEffect(() => {
    ...
    if (router.query.slug) {
      ...
      let detailURL;
      if ( locale === "nl" ) {
        detailURL = process.env.NEXT_PUBLIC_WORDPRESS_URL + "/wp-json/wp/v2/collections?slug=" + router.query.slug + "&lang=nl";;
      } else {
        detailURL = process.env.NEXT_PUBLIC_WORDPRESS_URL + "/wp-json/wp/v2/collections?slug=" + router.query.slug;
      ...
      fetch(detailURL, {
        ...
        .then((data) => {
          ...
          localStorage.backLink = "/collection/" + router.query.slug;
  ...
  const existingRoutes = ['/collection/luna-collection'];
  if ( !attemptedPath.includes('luna-collection') ) {
        ...
        {mainImage ? (
          ...
          >
            <div className="r-container">
              ...
              <h1 id="pageTitle" className="title text-capitalize mb-5">
            ...
            <div className="product-panel row">
              {(productsLoaded && product && product.length > 0) ? (
                product.map((item, index) => (
                  ...
                  <Link
                  href= {"javascript:window.location.href='/" + ((locale == 'en') ? "" : "nl/") + ((item.tags.indexOf("variants") == -1) ? "jewelry" : "shop") + "/" + surl.split("/")[surl.split("/").length - 2] + "/" + surl.split("/")[surl.split("/").length - 1] + "/" + getFilterValue(item.title) + "-" + item.shopifyid + ((surl1 != "?undefined") ? surl1 : "") + "';"}
                >
    ...
    return (
      ...
      {seoData.schema && (
        ...
        {mainImage ? (
          <div
            className="hero-section inner-content"
            style={{
              width:"100%",
              background:
                "url(" + mainImage + ")",
            ...
            <div className="r-container">
              ...
              {mainData  && (
                <div className="row guide-section">
                  {mainData.intro_left == "" && (
                    <div className="col-md-12 col-12 p-0 pt-sm-5 pt-4 pb-sm-5">
                      <p className="guide-text mb-4">
                        {renderHTML(mainData.intro_right)}
                      </p>
                    </div>
                  ...
                  {mainData.intro_left != "" && (
                    <div className="row">
                      ...
                      <div className="col-md-6 col-xs-12 p-0 ps-md-5 ps-0 pt-sm-5 pt-4 pb-sm-5">
                        <p className="guide-text mb-4">
                          {renderHTML(mainData.intro_right)}
                        </p>
                      </div>
