    ...
    <div className="warranty_page">
      ...
      <div className="hero-section">
        <div className="r-container">
          <h1 className="title text-capitalize mb-5 blue-text">
            {locale === "nl" ? "Levering," : "Delivery,"}<br />{locale === "nl" ? "Warranty" : "Warranty"} &<br />{locale === "nl" ? "Geeft terug" : "Returns"}
          </h1>
        </div>
      </div>
      ...
      <div className="guide-section">
        <div className="row r-container py-5">
          <div className="col-md-4 col-12 p-0 pe-md-5 pe-5 py-sm-5">
            <h3 className="title text-capitalize">{locale === "nl" ? "Ten volle" : "Fully"} <span>{locale === "nl" ? "Verzekerd" : "Insured"}</span></h3>
          </div>
      ...
      <div className="text-section">
        <div className="faq-list-panel py-5">
          <div className="r-container">
            <h3 className="title mt-5">{locale === "nl" ? faqDeliveryListNl.title : faqDeliveryList.title }</h3>
