...
function ConfirmDiamond(props) {
  ...
  const confirmSetting = () => {
    ...
    router.push('/customRing/confirmRing')
  ...
  useEffect(() => {
    ...
    if (true) {
      let ss = localStorage.choosenDiamond;
      let formData = new FormData();
      formData.append("shopifyid", ss);
      fetch(getProductURL, {
        method: "post",
        body: formData,
      })
  ...
  return (
    <div className="confirmDiamond_page" id="productPage">
      <Head>
      ...
      <div className="state-section">
        <div className="link-panel r-container py-3 d-sm-flex d-none align-items-center">
          ...
          <Link passHref={true} href="/customRing/chooseSetting">
            <a className="mx-2">CHOOSE SETTING</a>
          </Link>
          /
        ...
        <div className="confirm-section py-5 mb-5 row r-container">
          ...
          <div className="show-setting col-md-6 col-12 p-0 pt-5 ps-5">
            <div className="title-panel">
              ...
              <p className="product-id pb-4 m-0">SKU {productData.variants[0].sku}</p>
...
export default connect(mapStateToProps, mapDispatchToProps)(ConfirmDiamond);
