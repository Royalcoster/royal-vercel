...
function ConfirmSetting(props) {
  ...
  const confirmSetting = () => {
    ...
    router.push('/customRing/chooseDiamond')
  ...
  useEffect(() => {
    ...
    if (true) {
      let ss = localStorage.choosenSetting;
      let formData = new FormData();
  ...
  return (
    <div className="confirmSetting_page" id="productPage">
      <Head>
...
export default connect(mapStateToProps, mapDispatchToProps)(ConfirmSetting);
