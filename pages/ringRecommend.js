    ...
    <div className="ringRecommend_page">
      ...
      <div className="hero-section d-md-block d-flex flex-column justify-content-end">
        <div className="r-container">
          <h1 className="title text-white text-capitalize">
            {locale === "nl" ? "Ring" : "Ring"}
            <br />
            {locale === "nl" ? "Aanbeveler" : "Recommender"}
          </h1>
        </div>
      </div>
      {/* End Hero section */}
      ...
      <div className="guide-section py-md-5">
        <div className="row r-container py-5">
          <div className="col-lg-3 col-md-4 col-12 p-0 pe-md-5 pe-5 py-5">
            <h3 className="title text-capitalize">{locale === "nl" ? "We zoeken voor je" : "We’ll find for you"}</h3>
          </div>
          <div className="col-lg-9 col-md-8 col-12 p-0 ps-md-5 ps-0 pt-md-5 pb-5">
            <p className="guide-text">
            {locale === "nl" ? "We vinden de perfecte diamant en zetting binnen uw budget. Beantwoord een paar simpele vragen en we stellen een prachtige verlovingsring samen. We beloven dat het niet zo ingewikkeld zal zijn als het invullen van uw belastingaangifte." : "We’ll find the perfect diamond and setting within your budget. Just answer a few simple questions and we’ll put together a beautiful engagement ring. We promise it won’t be as complicated as filling out your tax returns."}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="pick-choice-section r-container py-md-5">
        <div className="title-panel my-5 pt-md-5">
          ...
          {locale === "nl" ? "Kies je keuze" : "Pick your choice"}
          </h3>
        </div>
        <div className="row pick-panel m-0 pt-md-5">
          <div className="stepper-panel row mb-5">
            ...
            <div className="content-panel col-md-8 mt-md-0 mt-5">
              <div className={"price-point-panel mb-5 d-none" + (activeStep == 0 ? "1 d-block" : "")}>
                ...
                {locale === "nl" ? "Mijn prijspunt is..." : "My Price point is..."}
                </label>
                <select
              ...
              <div className={"diamon-shape-panel mb-5 d-none" + (activeStep == 1 ? "1 d-block" : "")}>
                ...
                {locale === "nl" ? "Mijn diamanten zijn..." : "My Diamonds is..."}
                </label>
                <select
              ...
              <div className={"looking-for-panel mb-5 d-none" + (activeStep == 2 ? "1 d-block" : "")}>
                ...
                {locale === "nl" ? "Mijn zoek is..." : "My Looking for is..."}
                </label>
                <select
              ...
              <div className={"ring-style-panel mb-5 d-none" + (activeStep == 3 ? "1 d-block" : "")}>
                ...
                {locale === "nl" ? "contact" : "contact"}My Setting is... *Optional
                </label>
                <select
                  className="form-select price-point round-form px-4 py-3 text-capitalize"
                  id="ringStyle"
          ...
          <div className="round need-help-panel px-5 mb-4">
            <div
              ...
              <h3 className="text-uppercase m-0 mb-sm-0 mb-sm-5 mb-3">{locale === "nl" ? "Hulp nodig?" : "Need Help?"}</h3>
