...
const mainPageUrlEn = process.env.NEXT_PUBLIC_WORDPRESS_URL + "/wp-json/wp/v2/collections?slug=main-diamond-jewelry-page";
const mainPageUrlNl = process.env.NEXT_PUBLIC_WORDPRESS_URL + "/wp-json/wp/v2/collections?slug=main-diamond-jewelry-page&lang=nl";
...
const silderData = [
  { tags: "OMEGA", productType:"watches", image: "omega.png", url:"/shop?tags=OMEGA&productType=watches" },
  { tags: "tag-heuer", productType:"watches", image: "tag_heuer.png",url:"/shop?tags=TAG-Heuer&productType=watches" },
  { tags:"chopard", productType:"watches", image: "chopard.png" ,url:"/shop?tags=chopard&productType=watches"},
  { tags:"tudor", productType:"watches", image: "tudor.png" ,url:"/shop?tags=tudor&productType=watches"},
  { tags: "piaget", productType:"watches", image: "piaget.png",url:"/shop?tags=piaget&productType=watches" },
  { tags: "longines", productType:"watches", image: "longines.png",url:"/shop?tags=longines&productType=watches" },
  { tags: "frederique-constant", productType:"watches", image: "frederique.png",url:"/shop?tags=Frederique-Constant&productType=watches" },
  { tags: "titoni", productType:"watches", image: "titoni.png",url:"/shop?tags=titoni&productType=watches" },
  { tags: "hamilton", productType:"watches", image: "hamilton.png",url:"/shop?tags=hamilton&productType=watches" },
...
const basicData = [
  ...
  {
    title: "Tudor Diamond Watches",
    description:
      "Superior craftsmanship in a range from grand complications to refined three-hand watches. These are the Tudor Luxury Watches.",
    btnText: "Show Tudor watches",
    coverImage: "watch-cover-1.png",
    itemTitle: "Tudor Watches",
  },
  {
...
const urlEn = process.env.NEXT_PUBLIC_WORDPRESS_URL + "/wp-json/wp/v2/collections/327664";
const urlNl = process.env.NEXT_PUBLIC_WORDPRESS_URL + "/wp-json/wp/v2/collections/329483";
...
export default function Watch(props) {
  ...
  useEffect(() => {
    ...
    $(document).ready(function() {
      ...
      var ww1 = setInterval(function() {
         if ($("[watches]").length > 0) {
            clearInterval(ww1);
            $("[watches]").bind("click", function(e) {
              e.preventDefault();
              window.location.href = $(this).attr("watches");
            })
         }
       },100)
        ...
        /*    fetch(productURL, {
              ...
              .then((r) => {
                console.log(r)*/
                  ...
                  // setLoading(watchDataTemp.length);
                    setLoading(false);
                 }
  ...
  return (
      ...
      {pageData && loaded && (
        <div className="hero-section" id="hero">
          <div className="r-container">
            <p className="text-capitalize">{renderHTML(pageData.page_title_top)}</p>
    ...
    {pageData && loaded && (
      ...
      {pageData && loaded &&  (
           <WatchDetails watchData={watchData} loading={loading} vlength={dataLength} folder="jewelry-collections" />
