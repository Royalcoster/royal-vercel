    ...
    <div className="our-experts_page">
      ...
      <div className="hero-section">
        <div className="r-container">
          ...
          {locale === "nl" ? "Ons" : "Our"} <br /><span>{locale === "nl" ? "Experts" : "Experts"}</span>
          </h1>
        </div>
      </div>
      ...
      <div className="guide-section">
        <div className="row r-container py-5">
          <div className="col-md-4 col-12 p-0 pe-md-5 pe-5 py-sm-5">
            <h3 className="title text-capitalize">{locale === "nl" ? "Creatief" : "Creative"} <br /><span>{locale === "nl" ? "Bemanning" : "Crew"}</span> {locale === "nl" ? "achter Coster" : "behind Coster"}</h3>
          </div>
