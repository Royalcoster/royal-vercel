...
const timeLineListsNl = [
  {
    title: "Deel uw idee",
    description:
      "Neem contact op met ons ontwerpteam om ons te laten weten welke juwelen u zou willen maken. Hoe gedetailleerder uw aanvraag, hoe gemakkelijker wij uw droomjuweel kunnen maken. Zodra u akkoord gaat met een ontwerp, zullen onze experts u een prijsopgave doen voor uw op maat gemaakt sieraad.",
    image: "item-1.png",
  },
  {
    title: "Ontwerp uw product.",
    description:
      "Na betaling van een voorschot begint ons team te werken aan de fijne details van uw stuk. Dit is een gezamenlijk proces tussen u en de ontwerper. Om uw visie beter te illustreren, kunnen wij u tekeningen, computerontwerpen en proefmodellen van het juweel bezorgen. Onze experts gaan pas over tot productie als u volledig tevreden bent met het resultaat.",
    image: "item-2.png",
  },
  {
    title: "Ontvang uw droomjuweel.",
    description:
      "Neem contact op met ons ontwerpteam om ons te laten weten welke juwelen u zou willen maken. Hoe gedetailleerder uw aanvraag, hoe gemakkelijker wij uw droomjuweel kunnen maken. Zodra u akkoord gaat met een ontwerp, zullen onze experts u een prijsopgave doen voor uw op maat gemaakte sieraad.",
    image: "item-3.png",
  },
];
    ...
    <div className="bespoke_page">
      ...
      <div className="hero-section">
        <div className="r-container">
          ...
          {locale === "nl" ? "vakkundig" : "Expertly"} <span>{locale === "nl" ? "vervaardigd" : "crafted"}</span>.<br />
          {locale === "nl" ? "Voor eeuwig de jouwe." : "Eternally yours."}
          </h1>
        </div>
      </div>
      {/* End Hero section */}
      ...
      <div className="guide-section py-5">
        <div className="row r-container py-sm-5 py-3">
          <div className="col-lg-3 col-md-4 col-12 p-0 pe-md-5 pe-5 py-sm-5">
            <h3 className="title text-capitalize">{locale === "nl" ? "Wij zullen u begeleiden" : "We will guide you"}</h3>
          </div>
          <div className="col-lg-9 col-md-8 col-12 p-0 ps-md-5 ps-0 pt-sm-5 pt-4 pb-sm-5">
            <p className="guide-text">
            {locale === "nl" ? "Om je sieraden een verhaal te laten vertellen, kun je soms het beste het verhaal inspireren. Maak uw visie werkelijkheid door middel van onze uitstekende service op maat. Van verlovingsringen tot trouwringen tot unieke sieradencreaties, ons team van experts zal u begeleiden bij het creatieve proces van het ontwerpen van fijne sieraden." : "For your jewellery to tell a story, sometimes it’s best you inspire the narrative. Craft your vision into reality through our outstanding bespoke service. From engagement rings, to wedding bands, to unique jewellery creations, our team of experts will guide you through the creative process of fine jewellery design."}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="journey-section py-5 r-container">
        ...
        {locale === "nl" ? "De" : "The"} <span>{locale === "nl" ? "reis" : "Journey"}</span>
          <br />
          {locale === "nl" ? "van Jewel" : "of Jewel"}
        </h3>
          ...
          <div className="r-container">
            <div className="row mt-5 mx-0">
              <div className="col-md-6 p-0 pe-5 py-5">
                ...
                {locale === "nl" ? "Royal Coster Signature Creaties" : "Royal Coster Signature Creations"}
                </h3>
              </div>
              <div className="col-md-6 p-0 ps-lg-5 pt-md-5 pb-5">
                <p className="m-0 ps-lg-5 ms-lg-5">
                {locale === "nl" ? "Van eigentijdse stukken tot tijdloze ontwerpen, tot eenvoudige aanpassingen, ontdek het vakmanschap van fijn vakmanschap." : "From contemporary pieces, to timeless designs, to simple alterations, discover the artistry of fine craftsmanship."}
                </p>
              </div>
            </div>
          </div>
