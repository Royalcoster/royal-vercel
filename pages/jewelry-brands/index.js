...
const mainPageUrlEn = process.env.NEXT_PUBLIC_WORDPRESS_URL + "/wp-json/wp/v2/collections?slug=jewelry-brands-main";
const mainPageUrlNl = process.env.NEXT_PUBLIC_WORDPRESS_URL + "/wp-json/wp/v2/collections?slug=jewelry-brands-main&lang=nl";
...
const urlEn = process.env.NEXT_PUBLIC_WORDPRESS_URL + "/wp-json/wp/v2/collections/327477";
const urlNl = process.env.NEXT_PUBLIC_WORDPRESS_URL + "/wp-json/wp/v2/collections/327583";
...
export default function Watch(props) {
  ...
  return (
    ...
    {pageData && loaded && (
      ...
      {pageData && loaded &&  (
           <WatchDetails watchData={watchData} loading={loading} vlength={dataLength} folder="jewelry-brands" />
