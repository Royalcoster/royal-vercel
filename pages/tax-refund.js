      ...
      <div className="hero-section">
        <div className="r-container">
          <h1 className="title text-white text-capitalize mb-5">
            {locale === "nl" ? "Belastingteruggave" : "Tax Refund"} <br />
            {locale === "nl" ? "Problemen" : "Issues"}
          </h1>
        </div>
      </div>
        ...
        <div className="row r-container py-5">
          <div className="col-md-4 col-12 p-0 pe-md-5 pe-5 py-sm-5">
            <h3 className="title text-capitalize">
              {locale === "nl" ? "moeite met" : "difficulty in"} <span>{locale === "nl" ? "terugbetaling?" : "refund?"}</span>
            </h3>
          </div>
          <div className="col-md-8 col-12 p-0 ps-md-5 ps-0 pt-sm-5 pt-4 pb-sm-5">
            <p className="guide-text mb0-4">
              {locale === "nl" ? "Voor klanten van buiten de Europese Unie bieden we belastingteruggave op hun aankopen. Wanneer u een aankoop doet, geven onze diamantconsulenten of verkoopmedewerkers u een gedetailleerde uitleg over hoe u uw belastingteruggave kunt claimen. Zorg ervoor dat u de 3 volgende stappen rechts (desktop) of hieronder (mobiel) uitvoert om uw belastingaftrek te claimen." : "For customers from outside the European Union, we offer a tax refund on their purchases. When you make a purchase, our diamond consultants or sales staff give you a detailed explanation on how to claim your tax refund. To claim your tax deduction, please make sure to do the 3 following steps on the right (desktop) or below (mobile)."}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="row m-0 py-sm-5">
          <div className="col-md-4 p-0 pe-5">
            <h3 className="title blue-text">
              {locale === "nl" ? "Als je nog steeds problemen ondervindt, vul dan het contact in het formulier." : "If you still experienced difficulties, please fill in the contact form."}
            </h3>
          </div>
        ...
        <div className="r-container">
          <div className="step-title py-5">
            <h3 className="title text-center blue-text mb-0">
              {locale === "nl" ? "Belasting" : "Tax"} <span>{locale === "nl" ? "Terugbetaling" : "Refund"}</span>
              <br />
        ...
        <div className="booking-panel round row my-5">
          <div className="col-md-6">
            <div className="booking-list-panel py-4 px-md-5 px-4 round">
              <div className="title-panel d-flex justify-content-between align-items-center flex-lg-row flex-md-column flex-sm-row flex-column mb-5">
                <h3 className="title text-capitalize">{locale === "nl" ? "Openingstijden" : "Opening hours"}</h3>
              </div>
          ...
          <div className="col-md-6 mt-md-0 mt-5">
            <div className="direction-panel round py-4 px-md-5 px-4 d-flex flex-column">
              <div className="title-panel d-flex justify-content-between align-items-center flex-lg-row flex-md-column flex-sm-row flex-column mb-5">
                <h3 className="title text-capitalize">{locale === "nl" ? "Richting" : "Direction"}</h3>
                <div className="status py-2 px-4">{locale === "nl" ? "KRIJG RICHTING" : "GET DIRECTION"}</div>
              </div>
              <iframe
