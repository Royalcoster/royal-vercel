            ...
            <div className="r-container">
              <div className="welcome-panel round my-5 p-5">
                <h3 className="title mb-4 text-capitalize">
                  <span>{locale === "nl" ? "Hallo " : "Hello "} </span>
                  {JSON.parse(localData.login_user).firstName}
                </h3>
                <p className="description mb-0 text-capitalize">
                {locale === "nl" ? "Hier vindt u uw persoonlijke gegevens. Indien " : "Here you will find your personal details. If "}<br />
                {locale === "nl" ? "gewenst kunt u deze hier ook wijzigen." : "desired, you can also change it here."}
                </p>
              </div>
                ...
                >
                  ...
                  {accessToken && (
                    ...
                    >
                      ...
                      {locale === "nl" ? "Mijn wenslijst" : "My WishList"}
                    </button>
                  )}
                  <button
                  ...
                  >
                    ...
                    {locale === "nl" ? "Mijn aankopen" : "My Purchases"}
                  </button>
                  <button
                  ...
                  >
                    ...
                    {locale === "nl" ? "Mijn details" : "My Details"}
                  </button>
                  <button
                  ...
                  >
                    ...
                    {locale === "nl" ? "Mijn adres" : "My Address"}
                  </button>
                  <button
