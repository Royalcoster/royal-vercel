...
export default function Detail({ data }) {
  ...
  return (
    <div className="details_panel">
      <h3 className="title">{locale === "nl" ? "Mijn details" : "My Details"}</h3>
      <form onSubmit={setUserInfo} name="setUserForm">
        <div className="edit-panel row mt-4">
          <div className="edit-info-panel col-md-6">
            ...
            {locale === "nl" ? "Naam/e-mail wijzigen" : "Change name/email"}
            </h3>
            <input
              type="text"
              value={firstName}
          ...
          <div className="edit-password-panel col-md-6">
            <h3 className="sub-title mb-3 text-capitalize">
            {locale === "nl" ? "Verander wachtwoord" : "Change password"}
            </h3>
            <Link href="/myaccount/resetPassword">
              <a className="btn blue-btn btn-reset-password text-uppercase">
              {locale === "nl" ? "Wachtwoord opnieuw instellen" : "Reset Password"}
              </a>
            </Link>
           {/* <input
              type="password"
        ...
        <div className="confirm-panel">
         {/* <input
          ...
          <button
            ...
            disabled={loading}
          >
            {locale === "nl" ? "VAN TOEPASSING ZIJN" : "APPLY"}
            {loading ? (
              <Spinner
                as="span"
                animation="border"
