      ...
      <div className="row m-0">
        ...
        <div className="col-md-4 col-12 p-0 ps-md-3 help-items">
          ...
          onClick={(e) => {
              ...
              setTimeout(function() {
                $("#appointmentForm").find("#online").val("find_showroom_pdp");
                $("#appointmentForm").find("#visit").val("find_showroom_pdp_online");
                $("#appointmentForm").find("#idvisit").val("022");
                $("#appointmentForm").find("#idonline").val("023");
