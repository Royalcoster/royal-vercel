...
export default function WatchDetails({ watchData, loading, vlength, folder="watch" }) {
              ...
              >
                <div className="watch-info-panel row m-0 mb-5">
                  ...
                  >
                    <h3
                      className={
                        "blue-text watch-title mb-md-5 mb-3 " +
                    ...
                    >
                      <Link
                        href={{
                          pathname: folder + "/" + watch.royalcoster_slug,
                ...
                {watch.data.length ? (
                                  ...
                                  >
                                    <a>
                                      <div   style={{
                                        ...
                                        }} className="image-panel round hover-scale mb-3">
                                      {/*}  <img
                                          src={item.image}
                  ...
                  <h3 style={{display:"none"}} className="py-5 text-center empty-text">No product</h3>
                )}
              </div>
            )
        )}
