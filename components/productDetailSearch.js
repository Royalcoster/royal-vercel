...
export default function ProductDetailSearch({
  informations,
  productID,
  productDescription,
  productType,
  ...
  return (
    ...
    { productType.toString().toLowerCase() != "watches" && (
        <h3 className="pb-5 blue-text title">Diamond Details</h3>
    )}
    { productType.toString().toLowerCase() == "watches" && (
        <h3 className="pb-5 blue-text title">About this watch</h3>
    )}
      ...
      { productType.toString().toLowerCase() == "watches" && (
        <h3 className="blue-text">Reference Number {reference}</h3>
      )}
